...
from utils import constant_semeval as constant, helper, vocab
import pickle
...
class DataLoader(object):
    ...
    def __getitem__(self, key):
        ...
        subj_positions = get_long_tensor(batch[4], batch_size, fill_value=150)[:, :num_actual_tokens]
        obj_positions = get_long_tensor(batch[5], batch_size, fill_value=150)[:, :num_actual_tokens]
